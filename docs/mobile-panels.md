...
- `FORCE_REACT_RENDER_FOR_SETTLED_ANIMATIONS` stays off in `apps/ui/package.json`. It is a
...
`apps/ui/src/mobile-panels/model.test.ts` exercises command, drag, cancellation, interruption,
