...
| `getPendingOpenProject`, `agentNavigation.ready` | Rust state seeded from CLI args / `paseo://` deep links, drained once.                                                                                                                                                                                                                                             |
...
| `dialog.ask/askWithCheckbox/open`                | `tauri-plugin-dialog`. `askWithCheckbox` has no native equivalent; implemented as ask with the "don't ask again" state kept in desktop settings.                                                                                                                                                                   |
| `notification.*`                                 | `tauri-plugin-notification`; clicks emit `paseo:event:notification-click`.                                                                                                                                                                                                                                         |
...
- `get_desktop_settings`, `patch_desktop_settings`: JSON file in the app config dir.
