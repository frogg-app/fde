...
Paseo client UI translations live in `apps/ui/src/i18n`.
...
English source strings live in `apps/ui/src/i18n/resources/en.ts`. Each supported locale has a matching resource in `apps/ui/src/i18n/resources`.
