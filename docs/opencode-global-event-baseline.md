...
- `apps/cli/tests/e2e/opencode-invalid-model.test.ts`: Vitest reports "No test suite found in file".
...
- `apps/cli/tests/e2e/opencode-invalid-model.test.ts`: unchanged; Vitest still reports "No test suite found in file".
