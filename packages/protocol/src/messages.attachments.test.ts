...
describe("shared messages attachments", () => {
      ...
      attachments: [
        {
          type: "text",
          mimeType: "text/plain",
          title: "ENG-123 External attachments",
          text: "Linear issue ENG-123: External attachments",
          externalResource: {
            provider: "linear",
            ...
            url: "https://linear.app/acme/issue/ENG-123/external-attachments",
          },
        },
      ],
    });
  ...
  it("keeps known firstAgentContext attachments and drops unknown ones", () => {
    const parsed = CreateFroggWorktreeRequestSchema.parse({
        ...
        attachments: [
          {
            ...
            url: "https://github.com/frogg-app/frogg/pull/99",
          },
          {
            type: "future_attachment",
            mimeType: "application/future",
