...
import { deriveTerminalActivityStatusBucket } from "@frogg/protocol/terminal-activity";
  ...
  return {
    ...
    async createTerminal(options: {
      ...
      const activityEnv = {
        ...
        FROGG_ACTIVITY_TOKEN: activityToken,
        ...(terminalActivityUrl ? { FROGG_TERMINAL_ACTIVITY_URL: terminalActivityUrl } : {}),
      };
