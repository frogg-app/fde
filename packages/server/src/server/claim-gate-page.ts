...
button{background:var(--accent);color:#04191d;border:0;border-radius:8px;padding:9px 14px;font-weight:600;cursor:pointer}
...
<main>
  ...
  <p>The daemon on <span class="host">${escapeHtml(input.hostname)}</span> has no paired device yet. The first device that pairs becomes its owner.</p>
  ${qr}
  <ol>
    <li>Open the FDE desktop or mobile app.</li>
    <li>Choose <em>Pair a daemon</em>, then scan this code or paste the link.</li>
