 ...
 *
 * Verified on the wire (Claude Code 2.1.220, Frogg's own query options):
 *
...
export class ClaudeTaskProtocolSource {
   ...
   * value Frogg requested is not necessarily the one that ran, because a model that does not
