import { createHubCommand } from "../../../../../../apps/cli/src/commands/hub/index.js";
import { HubHttpClient } from "../../../../../../apps/cli/src/commands/hub/hub-client/index.js";
...
const argv = [process.argv[0] ?? "node", process.argv[1] ?? "frogg", ...process.argv.slice(3)];
