...
describe("WorkspaceReconciliationService", () => {
  ...
  test("keeps legacy duplicate projects and workspace membership intact", async () => {
    ...
    const canonicalWorktreeDir = path.join(repoDir, ".frogg", "worktrees", "focused-bat");
    const duplicateWorktreeDir = path.join(repoDir, ".frogg", "worktrees", "gigantic-blowfish");
