...
test("manifest lists only platforms with a signature", () => {
  ...
  assert.deepEqual(manifest, {
    ...
    platforms: {
      "linux-x86_64": {
        signature: "sig-linux",
        url: "https://github.com/frogg-app/frogg-de/releases/download/v0.1.5/FDE-0.1.5-x86_64.AppImage",
      },
      "darwin-aarch64": {
        signature: "sig-mac",
        url: "https://github.com/frogg-app/frogg-de/releases/download/v0.1.5/FDE-0.1.5-aarch64.app.tar.gz",
      },
    },
  });
});
