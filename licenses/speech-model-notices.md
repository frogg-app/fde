...
Frogg downloads speech models separately; their data/model/component terms are
independent of Frogg's Apache-2.0 source license. Preserve upstream files and notices
...
hosting workflow. Frogg's catalog requires the model, tokens and phonemizer data and
