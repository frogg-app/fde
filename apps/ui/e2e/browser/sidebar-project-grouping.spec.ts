...
const GROUPED_PROJECT_NAME = "frogg-e2e/grouped-project";
const SHARED_REMOTE_URL = "https://github.com/frogg-e2e/grouped-project.git";
...
async function removePersistedProjectKeys(host: IsolatedHostDaemon): Promise<void> {
  const projectsPath = path.join(host.froggHome, "projects", "projects.json");
