...
const GROUPED_PROJECT_NAME = "fde-e2e/grouped-project";
const SHARED_REMOTE_URL = "https://github.com/fde-e2e/grouped-project.git";
...
async function removePersistedProjectKeys(host: IsolatedHostDaemon): Promise<void> {
  const projectsPath = path.join(host.fdeHome, "projects", "projects.json");
