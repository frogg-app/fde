...
const FILE_PATH =
  "apps/ui/src/command-center/features/workspace-file-search/layout-stability/needle-layout-stability-command-center.tsx";
...
function froggSizedFiles(): Array<{ path: string; content: string }> {
...
test("workspace file search stays geometrically stable through delayed loading and results", async ({
  ...
  const seeded = await seedWorkspace({
    ...
    title: "Frogg-shaped file search",
    repo: { files: froggSizedFiles() },
  });
