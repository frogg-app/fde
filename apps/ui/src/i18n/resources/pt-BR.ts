...
export const ptBR: TranslationResources = {
  ...
  pairing: {
    ...
    remoteSsh: {
      ...
      errors: {
        ...
        sshHostKey:
          "A chave de host de {{host}} é desconhecida ou mudou. Conecte uma vez pelo terminal com ssh para aceitá-la.",
      },
    },
    link: {
      title: "Colar link de pareamento",
  ...
  companion: {
    ...
    error: {
      startFailed: "Não foi possível iniciar o Companheiro",
    ...
    settings: {
      ...
      replyText: {
        ...
        description: "Leia o que o Companheiro está dizendo enquanto ele fala.",
      },
    },
  },
  spokenAlerts: {
    ...
    errors: {
      ...
      noAudio: "O host ainda não tem áudio para este alerta. Tente novamente.",
  ...
  settings: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        toggleCompanion: "Alternar o Companheiro",
    ...
    host: {
      ...
      sshDeploy: {
        ...
        probe: {
          ...
          service: {
            systemd: "serviço de usuário systemd",
            launchd: "agente launchd",
            none: "sem gerenciador de serviços de usuário",
          },
          docker: {
            label: "Docker",
        ...
        method: {
          ...
          native: "Nativo",
          docker: "Docker",
          dockerHint: "O Docker não está disponível neste host.",
        },
        fields: {
      ...
      agentDefinitions: {
        ...
        loadFailed: "Não foi possível carregar as definições de agentes",
        unsupported: "Atualize o daemon deste host para listar as definições de agentes",
      ...
      daemon: {
        ...
        selfUpdate: {
          ...
          info: "Atualiza um daemon instalado com install.sh (ou pelo deploy SSH do app desktop) a partir das releases do GitHub. O daemon baixa a nova versão ao lado da atual, reinicia com ela e volta sozinho para a versão anterior se a nova não subir.",
          versionLabel: "Daemon {{version}}",
          versionUnknown: "Versão do daemon desconhecida",
          hint: "Verifica se o canal de releases tem um daemon mais novo",
          check: "Verificar atualizações do daemon",
          checking: "Verificando...",
          upToDate: "O daemon está atualizado",
          ...
          outcome: {
            applied: "Atualizado de {{from}} para {{to}}",
            rolled_back: "A atualização para {{to}} falhou; voltou para {{from}}",
            failed: "A atualização de {{from}} para {{to}} falhou",
          },
          autoUpdate: {
