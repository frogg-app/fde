    ...
    host: {
      ...
      daemon: {
        ...
        selfUpdate: {
          ...
          confirmMessage: "يعيد البرنامج الخفي التشغيل بالإصدار الجديد؛ وتتوقف الوكلاء العاملة لفترة وجيزة. إذا فشل الإصدار الجديد في البدء، يُستعاد الإصدار السابق تلقائيًا.",
          confirm: "تحديث",
