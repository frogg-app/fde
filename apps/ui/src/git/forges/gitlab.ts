...
import type { CheckoutPipelineJob, CheckoutPrMergeMethod } from "@frogg/protocol/messages";
import {
  CHECK_TRAIT_ACTION_REQUIRED,
  CHECK_TRAIT_MANUAL,
  CHECK_TRAIT_WARNING,
} from "@frogg/protocol/check-traits";
import { GITLAB_ACTIVE_PIPELINE_STATUS_SET } from "@frogg/protocol/gitlab-pipeline";
