...
function buildAnnotationMarkerScript(markers: readonly BrowserAnnotationMarker[]): string {
  ...
  return `
    (function() {
      var markers = ${payload};
      if (window.__froggAnnotationMarkers) { window.__froggAnnotationMarkers.update(markers); return true; }
      ...
      window.__froggAnnotationMarkers = {
        ...
        destroy: function() {
          ...
          window.__froggAnnotationMarkers = null;
        }
      };
      reposition();
      return true;
...
function clearAnnotationMarkers(webview: ElectronWebview): void {
  void executeWebviewJavaScript(
    webview,
    "if(window.__froggAnnotationMarkers) window.__froggAnnotationMarkers.destroy();",
