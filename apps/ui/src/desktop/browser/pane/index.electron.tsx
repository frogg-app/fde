...
function buildAnnotationMarkerScript(markers: readonly BrowserAnnotationMarker[]): string {
  ...
  return `
    (function() {
      var markers = ${payload};
      if (window.__fdeAnnotationMarkers) { window.__fdeAnnotationMarkers.update(markers); return true; }
      ...
      window.__fdeAnnotationMarkers = {
        ...
        destroy: function() {
          ...
          window.__fdeAnnotationMarkers = null;
        }
      };
      reposition();
      return true;
...
function clearAnnotationMarkers(webview: ElectronWebview): void {
  void executeWebviewJavaScript(
    webview,
    "if(window.__fdeAnnotationMarkers) window.__fdeAnnotationMarkers.destroy();",
