...
const existingProject = join(await mkdtemp(join(tmpdir(), "fde-open-project-")), "project");
...
const previousDesktopCli = process.env.FDE_DESKTOP_CLI;
process.env.FDE_DESKTOP_CLI = "1";
...
process.env.FDE_DESKTOP_CLI = previousDesktopCli;
