...
const existingProject = join(await mkdtemp(join(tmpdir(), "frogg-open-project-")), "project");
...
const previousDesktopCli = process.env.FROGG_DESKTOP_CLI;
process.env.FROGG_DESKTOP_CLI = "1";
...
process.env.FROGG_DESKTOP_CLI = previousDesktopCli;
