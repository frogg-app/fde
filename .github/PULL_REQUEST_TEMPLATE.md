...
- [ ] Docs updated (or not needed): pages in `website/src/content/docs/docs/` and screenshots for user-visible, config, CLI, protocol-visible, branding or build changes (see `skills/fde-docs/SKILL.md`)
